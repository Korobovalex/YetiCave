...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo" href="index.php">
                <img class="logo--img" src="img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
            </a>
        </a>
...
<nav class="nav">
    ...
    <?php foreach ( $categories as $category ): ?>
        <li class="nav__item">
            <a href="index.php?cat_id=<?= $category['id']; ?>"><?=htmlspecialchars( $category['name'] ); ?></a>
        </li>
    <?php endforeach; ?>
    </ul>
</nav> 
